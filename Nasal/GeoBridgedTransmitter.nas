...
var geoRoutedNotifications = [notifications.ArmamentInFlightNotification.new()];#################################################### Error in this line ######################################################
var geoBridgedTransmitter = emesary.Transmitter.new("geoOutgoingBridge");
var geooutgoingBridge = emesary_mp_bridge.OutgoingMPBridge.new("B-1Bmp.geo",geoRoutedNotifications, 18, "", geoBridgedTransmitter);
...
var hitoutgoingBridge = emesary_mp_bridge.OutgoingMPBridge.new("B-1Bmp.hit",hitRoutedNotifications, 19, "", hitBridgedTransmitter);
...
var objectoutgoingBridge = emesary_mp_bridge.OutgoingMPBridge.new("B-1Bmp.object",objectRoutedNotifications, 17, "", objectBridgedTransmitter);
